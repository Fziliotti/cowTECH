  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      ...
      <section class="content container-fluid">
        <!-- CAIXAS DE INFORMAÇÕES PARA O CLIENTE -->
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Fazendas Registradas</span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-blue"><i class="ion ion-ios-personadd"></i></span>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-icon bg-green"><i class="ion ion-plus-round"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Bois Cadastrados</span>
                <span class="info-box-number">710</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              ...
              <div class="info-box-content">
                <span class="info-box-text">Piquetes Cadastrados</span>
